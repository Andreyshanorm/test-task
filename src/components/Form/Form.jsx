...
import { SumbitRightSection } from "./SubmitRightSection/SumbitRightSection";
import { SubmitLeftSection } from "./SubmitLeftSection/SubmitLeftSection";
...
export const Form = () => {
  ...
  return (
    <>
      <h1 className={styles.margin_mobile}>{isFormSubmited ? 'Ждём тебя!' : 'Работа твоей мечты!'}</h1>
          ...
          {isFormSubmited ? (
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <label className={styles.name_data}>
                ...
                />
                <div id="error" style={{ color: "red", fontSize: "14px" }}>
                  {errors?.nameData && (
              ...
              <label className={styles.captha}>
                ...
                <p className={styles.capthaBlock}>
                  <div className={styles.capthaContent}>
                    <span
